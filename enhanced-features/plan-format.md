...
*Permanent reference template for project plan execution files*
...
- When exceeded during append:
  1. Rename current file to `project-plan-YYYYMMDD.md` (archived)
  2. Create fresh `project-plan.md` with new content
  3. Report: "Previous plan archived, new plan created"

## Resume Convention
After context reset or auto-compact:
...
## What NOT to Include
- Emoji (plan files are parsed programmatically)
- Large code blocks (put those in actual code files)
- Raw chat transcripts
- Completed plan files from previous projects

---
*Plan Format Template v1.0 | Installed 2026-02-28*
